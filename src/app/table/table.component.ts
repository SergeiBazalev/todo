...
import { IData, ISelect, TaskPriority, TaskStatus } from '../interfaces/all.interface';
import { MatButtonModule } from '@angular/material/button';

import { Store } from '@ngrx/store';
import { EMPTY, Observable } from 'rxjs';
import { addTask, loadTasks } from '../task-store/task.actions';
...
export class TableComponent implements OnInit {
  ...
  constructor(private store: Store<{ tasks: IData[] }>) {}
